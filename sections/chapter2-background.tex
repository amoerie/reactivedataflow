...
\begin{description}[style=nextline]
	...
	\item[The port] Uniquely identifies the position of the token, should an instruction need multiple tokens for a single invocation.
	\item[The execution context] This uniquely identifies a function call, and is meant to distinguish instruction invocations of different function calls. This essentially allows the graph to be made reentrant. 
\end{description}
