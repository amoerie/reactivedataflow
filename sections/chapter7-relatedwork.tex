...
In Elm, the constraints of the platform are slightly different. JavaScript does not support parallelization - at all - so while the Elm language has no technical constraints regarding parallelism, the end result is unfortunately not parallel. 
