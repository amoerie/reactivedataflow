...
(define program-inputs
  (list
   ...
   '(define square-signal-100 (lift (lambda (v90 v91 v92 v93 v94 v95 v96 v97 v98 v99) (res v99))
                                    square-signal-90 square-signal-91 square-signal-92 square-signal-93
                                    square-signal-94 square-signal-95 square-signal-96 square-signal-97
                                    square-signal-98 square-signal-99))
  )
)
...
(define (startup-dataflow-runtime)
  ...
  (define dataflow-manager (start-runtimes dataflow-instructions 16))
  ...
  (define results (dataflow-manager-processor-loop dataflow-manager (+ (current-milliseconds) 10000)))
